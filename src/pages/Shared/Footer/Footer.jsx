            ...
            <div className="p-5 w-11/12 mx-auto">
                <div className="grid lg:grid-cols-3 grid-cols-2  mb-20 gap-20">
                    <div className="lg:col-span-1 col-span-2">
                        ...
                        <p className="2xl:pr-30">eTutionbd is a comprehensive tuition management platform that connects students and tutors in one system. It enables tuition posting and tutor applications between students and tutors.</p>
                    </div>
                    <div>
                        <div>
