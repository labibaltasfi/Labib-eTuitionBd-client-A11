        ...
        <div className="min-h-screen bg-base-100 p-4 text-base-content transition-colors duration-300">
            ...
            <h1 className='text-center font-bold text-4xl py-10'>Tuition List</h1>
                <div className='grid lg:grid-cols-2 gap-4  justify-items-center'>
                    {
                        tuition.map((tuition) => (
                            <div key={tuition._id} className="w-full max-w-2xl h-35 rounded-2xl shadow-lg bg-base-200 border border-base-content/10 my-2">
                        <div className="p-6 flex justify-between items-center">
                            ...
                            <div>
                                <Link to={`/tuition-details/${tuition._id}`} className="p-4 rounded-xl bg-primary text-primary-content font-medium hover:brightness-110 transition">
                                    Details
                                </Link>
                            </div>
                        </div>
