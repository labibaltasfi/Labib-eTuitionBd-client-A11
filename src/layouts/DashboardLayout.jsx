...
const DashboardLayout = () => {
    ...
    const navItemClass = ({ isActive }) =>
        `is-drawer-close:tooltip is-drawer-close:tooltip-right relative flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all duration-200 ${
            isActive
    ...
    return (
        <div className="drawer lg:drawer-open max-w-7xl mx-auto min-h-screen">
            ...
            <div className="drawer-content bg-base-100">
                ...
                <nav className="mx-3 mt-3 rounded-2xl border border-slate-200 bg-[#f6f7f8] px-4 py-3">
   ...
   <label
                                ...
                                className="flex h-9 items-center gap-2 rounded-full border border-slate-200 bg-white px-3 text-sm font-medium text-slate-600 hover:bg-slate-100 cursor-pointer"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeLinejoin="round" strokeLinecap="round" strokeWidth="2" fill="none" stroke="currentColor" className="size-4"><path d="M4 6h16"></path><path d="M4 12h16"></path><path d="M4 18h16"></path></svg>
                                Sidebar
                            </label>
                            <div className="flex w-full items-center gap-3 rounded-xl border border-slate-200 bg-white px-3 py-2 shadow-sm lg:w-90">
                                ...
                                />
                                <span className="rounded-md bg-slate-100 px-2 py-1 text-xs font-semibold text-slate-500">Ctrl+F</span>
                            </div>
                        </div>

                        <div className="flex items-center justify-end gap-3">
                            add here sidebar open button
                            ...
                            <div className="flex items-center gap-3 rounded-xl border border-slate-200 bg-white px-2 py-1 shadow-sm">
                                <img
                                    src="https://i.ibb.co.com/hR0p6qhz/user.png"
                                    alt="User"
                                    className="h-10 w-10 rounded-full object-cover"
                                />
                                <div className="hidden sm:block">
                                    <p className="text-sm font-semibold text-slate-800">eTutionbd User</p>
                                    <p className="text-xs text-slate-500">Dashboard Account</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="drawer-side is-drawer-close:overflow-visible">
                ...
                <div className="flex min-h-full flex-col items-start border-r border-slate-200/60 bg-[#f6f7f8] px-3 py-4 is-drawer-close:w-20 is-drawer-open:w-72">
                  
                    <ul className="menu w-full grow">
                      
                         <li className="mb-5">
                            <Link to="/" className="flex items-center gap-3 rounded-2xl bg-white px-3 py-3 shadow-sm ring-1 ring-slate-200">
                                <img className="h-10 w-10 rounded-xl bg-emerald-50 p-2" src={logoImg} alt="" />
                                <div className="is-drawer-close:hidden">
                                    <p className="text-xl font-bold text-slate-800">eTutionbd</p>
                                    <p className="text-xs text-slate-500">Dashboard</p>
                                </div>
                            </Link>
                        </li>
                        <li className="mb-4 px-3 text-xs font-semibold uppercase tracking-wider text-slate-400 is-drawer-close:hidden">Menu</li>

                        <li>
                            <Link to="/" className="is-drawer-close:tooltip is-drawer-close:tooltip-right relative flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-slate-500 transition-all duration-200 hover:bg-slate-100 hover:text-slate-700" data-tip="Homepage">
                        ...
                        }
                       {
                        ...
                        <li className="mt-5 mb-2 px-3 text-xs font-semibold uppercase tracking-wider text-slate-400 is-drawer-close:hidden">General</li>

                        {/* List item */}
                        <li>
                            <button className="is-drawer-close:tooltip is-drawer-close:tooltip-right relative flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-slate-500 transition-all duration-200 hover:bg-slate-100 hover:text-slate-700" data-tip="Settings">
