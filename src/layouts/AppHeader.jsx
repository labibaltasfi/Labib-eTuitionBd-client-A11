        ...
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <Link to="/" className="lg:hidden">
            <span className="inline-flex items-center gap-2">
              <img
                className="h-10 w-10 dark:hidden rounded-xl"
                src={logoImg}
                alt="Logo"
              />
            ...
            <form>
              <div className="relative">
                {/* <input
                  ...
                  className="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pl-4 pr-14 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:outline-none dark:border-gray-800 dark:text-white xl:w-[430px]"
                />
